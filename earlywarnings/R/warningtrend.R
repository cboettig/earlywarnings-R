...
#' arguments such as the explicit time vector can be passed in
#' as optional arguments.  
#' @param windowsize the window size to use in calculating the warning signals.  Default of NULL corresponds to using half the length of the time window.  
