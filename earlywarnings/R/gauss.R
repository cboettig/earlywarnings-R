...
#' @title Simulate generic 
#' @param object any gauss-class object
#' @param ... additional arguments (currently ignored)
#' @param nsim the number of sims to perform (defaults to 1)
#' @param seed the random number seed to use
#' @return a data frame with the time simulated values
#' @rdname simulate 
#' @export simulate
simulate <- function(object, nsim, seed, ...) UseMethod("simulate")
...
#' desired model class
#' @param x the value at which the density is to estimated 
#' @param x0 the initial value 
#' @param to initial time
#' @param t1 end time
#' @param pars parameters passed to setmodel function
...
#' @param setmodel a function returning mean and variance for
#' the desired model class
#' @param x the value at which the density is to be estimated 
#' @param x0 the initial value 
#' @param to initial time
#' @param t1 end time
#' @param pars parameters passed to setmodel function
